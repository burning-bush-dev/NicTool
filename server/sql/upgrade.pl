...
sub _sql_test_2_44 {
    ...
    my $tbl = $dbh->query("SHOW TABLES LIKE 'nt_user_webauthn_credential'")->hashes;
...
CREATE TABLE nt_user_webauthn_challenge (
    ...
    UNIQUE KEY uk_challenge (challenge(64)),
    KEY idx_expires (expires_at)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

CREATE TABLE nt_user_recovery_code (
    nt_recovery_code_id   INT UNSIGNED AUTO_INCREMENT NOT NULL,
    nt_user_id            INT UNSIGNED NOT NULL,
    code_hash             VARCHAR(255) NOT NULL,
    code_salt             VARCHAR(16) NOT NULL,
    used_at               INT UNSIGNED DEFAULT NULL,
    created_at            INT UNSIGNED NOT NULL,
    PRIMARY KEY (nt_recovery_code_id),
    KEY idx_user_id (nt_user_id)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

ALTER TABLE nt_user_session_log MODIFY action ENUM('login','logout','timeout','passkey_login','recovery_login') NOT NULL;
